...
<template>
  <article class="fb-post" :class="{ compact }">
    <div class="fb-group-bar">
      <span class="fb-group-icon" aria-hidden="true">
        <svg viewBox="0 0 24 24" width="16" height="16">
          <path
            fill="#fff"
            d="M16.5 12a3 3 0 1 0-2.83-4H10.3A3 3 0 1 0 7 12a4.5 4.5 0 0 0-4 4.47V18h18v-1.53A4.5 4.5 0 0 0 16.5 12zM7 7.5A1.5 1.5 0 1 1 8.5 9 1.5 1.5 0 0 1 7 7.5zm9.5 0A1.5 1.5 0 1 1 18 9a1.5 1.5 0 0 1-1.5-1.5zM5 16.5A3 3 0 0 1 8 14h3.1a4.48 4.48 0 0 0 1.9 2.5H5zm14 0h-6.2A3 3 0 0 1 16 14h3a3 3 0 0 1 0 2.5z"
          />
        </svg>
      </span>
    ...
    <header class="fb-head">
      ...
      <div class="fb-id">
        ...
        <span>Posted in {{ groupName }} · Just now</span>
      </div>
    ...
    <img v-else-if="hero" class="fb-hero" :src="hero" :alt="`${companyName} Facebook group photo`" />
