    ...
    <div class="two-col">
      <div>
        ...
        <section class="section panel">
          ...
          <ul class="meta-list">
            ...
            <li v-if="project.location_display || project.city">
              ...
              <span>
                ...
                >
                  {{ project.location_display || project.city }}
                </NuxtLink>
                <template v-else>{{ project.location_display || project.city }}</template>
              </span>
            </li>
      ...
      <aside>
        ...
        <LeadForm
          ...
          :project-location="project.location_display || project.city || undefined"
